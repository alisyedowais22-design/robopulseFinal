...
export default function PostDetail() {
  ...
  const seoTitle = cleanTitle
    ? `${cleanTitle} — RoboPulse`
    : `${config.badge} — RoboPulse`

  const seoDescription =
    cleanExcerpt ||
    'Read this RoboPulse article covering humanoid robots, robotics technology, AI, automation, reviews, guides, and industry news.'
