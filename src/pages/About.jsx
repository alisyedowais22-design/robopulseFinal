...
export default function About() {
  return (
    <PageTransition>
      <>
        <SEO
          title="About RoboPulse — Independent Humanoid Robot Coverage"
          description="Learn about RoboPulse, an independent platform covering humanoid robot reviews, comparisons, guides, news, and robotics industry analysis."
          canonical="/about"
        />
