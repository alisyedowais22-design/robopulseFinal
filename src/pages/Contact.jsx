...
export default function Contact() {
  ...
  return (
    <PageTransition>
      <div className="pt-16">
        <SEO
          title="Contact RoboPulse — Editorial Tips, Corrections & Partnerships"
          description="Contact RoboPulse for editorial tips, corrections, press requests, advertising inquiries, research collaboration, robotics coverage, and partnership opportunities."
          canonical="/contact"
        />
        ...
        >
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse 50% 80% at 80% 50%, rgba(0,240,200,.05) 0%, transparent 70%)',
            }}
          />
          ...
          <div className="container-wide relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              <div className="flex items-center gap-2 mb-5">
                ...
                <span className="text-xs font-mono text-accent-teal uppercase tracking-widest">
                  Get In Touch
                </span>
              </div>

              <h1
                className="font-heading tracking-heading text-text-primary mb-4"
                style={{
              ...
              <div>
                ...
                {sent ? (
                  ...
                  >
                    ...
                    <p className="font-heading text-2xl tracking-heading text-text-primary mb-2">
                      Message Sent
                    </p>
                    <p className="text-sm text-text-secondary">
                      We'll respond within 1–2 business days. Editorial tips may take longer if we're verifying information.
                    </p>
                  </motion.div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-mono text-text-muted mt-3">
                        We respond to all messages within 1–2 business days. Editorial tips may take longer if we're verifying information.
                      </p>
                    </div>
                  </form>
                )}
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  {[
                    {
                      icon: '✉️',
                      label: 'Email (All Enquiries)',
                      val: (
                        <a
                          href="mailto:contentpublisherslimited@gmail.com"
                          className="text-accent-teal no-underline hover:underline"
                          style={{ fontSize: '14px', fontWeight: 500 }}
                        >
                          contentpublisherslimited@gmail.com
                        </a>
                      ),
                    },
                    {
                    ...
                    },
                    {
                      ...
                      val: (
                        <span className="text-text-primary text-sm leading-relaxed">
                          WRE Content Publishers Limited
                          <br />
                          368, 85 Dunstall Hill
                          <br />
                    ...
                    >
                      ...
                      <div>
                        <p className="text-xs font-mono text-text-secondary mb-0.5">
                          {m.label}
                        </p>
                        {m.val}
                      </div>
                ...
                >
                  <h3 className="font-heading text-lg tracking-heading text-text-primary mb-3">
                    FOLLOW THE PULSE
                  </h3>
                  <p className="text-xs text-text-secondary leading-relaxed mb-4">
                    Daily robot news, breaking model announcements, and our latest reviews — straight to your inbox or feed.
                  </p>
                  <div className="flex flex-col gap-2">
                    ...
                    <button
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.borderColor = '#00F0C8'
                ...
                >
                  <h3
                    className="font-heading text-lg tracking-heading mb-3"
                    style={{ color: '#6C63FF' }}
                  >
                    🤫 TIP LINE
                  </h3>
        ...
        <section className="py-16">
          <div className="container-wide">
            <div className="max-w-[760px]">
              ...
              <h2 className="font-heading text-3xl tracking-heading text-text-primary mb-6">
                Before you write
              </h2>
              <div>
                {FAQ.map((item, i) => (
